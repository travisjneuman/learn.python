# Solution: Module 02 / Project 04 -- File Processor CLI
...
```python
# WHY analyze_file: [explain the design reason]
# WHY format_report: [explain the design reason]
# WHY process: [explain the design reason]
...
|----------|-----|----------------------|
| analyze_file function | [reason] | [alternative] |
| format_report function | [reason] | [alternative] |
| process function | [reason] | [alternative] |
