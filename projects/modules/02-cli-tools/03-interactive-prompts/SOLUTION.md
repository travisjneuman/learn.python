# Solution: Module 02 / Project 03 -- Interactive Prompts
...
```python
# WHY check_answer: [explain the design reason]
# WHY show_result: [explain the design reason]
# WHY quiz: [explain the design reason]
...
|----------|-----|----------------------|
| check_answer function | [reason] | [alternative] |
| show_result function | [reason] | [alternative] |
| quiz function | [reason] | [alternative] |
