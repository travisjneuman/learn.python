# Solution: Module 02 / Project 02 -- Multi-Command CLI
...
```python
# WHY cli: [explain the design reason]
# WHY info: [explain the design reason]
# WHY count: [explain the design reason]
# WHY head: [explain the design reason]
...
|----------|-----|----------------------|
| cli function | [reason] | [alternative] |
| info function | [reason] | [alternative] |
| count function | [reason] | [alternative] |
