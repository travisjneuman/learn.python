# Solution: Module 05 / Project 06 — WebSocket Chat Server
...
```python
# WHY format_message: [explain the design reason]
# WHY get_server_info: [explain the design reason]
...
|----------|-----|----------------------|
| format_message function | [reason] | [alternative] |
| get_server_info function | [reason] | [alternative] |
