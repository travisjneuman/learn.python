# Solution: Module 03 / Project 03 — POST and Auth
...
# WHY get_with_custom_headers: [explain the design reason]
# WHY compare_get_and_post: [explain the design reason]
...
|----------|-----|----------------------|
| create_post function | [reason] | [alternative] |
| get_with_custom_headers function | [reason] | [alternative] |
| compare_get_and_post function | [reason] | [alternative] |
