# Level 10 / Project 02 - Input and Output Checker
...
## Focus
- input validation and clean outputs
...
## Alter it
Add runbook notes, guardrails, and extension points for handoff.

## Break it
Simulate incident mode and execute recovery checklist.
