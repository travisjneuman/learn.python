# Solution: Level 2 / Project 02 - Nested Data Flattener
...
```python
# WHY flatten: [explain the design reason]
# WHY unflatten: [explain the design reason]
# WHY flatten_from_file: [explain the design reason]
# WHY depth: [explain the design reason]
...
|----------|-----|----------------------|
| flatten function | [reason] | [alternative] |
| unflatten function | [reason] | [alternative] |
| flatten_from_file function | [reason] | [alternative] |
