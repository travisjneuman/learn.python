# Solution: Level 2 / Project 06 - Records Deduplicator
...
```python
# WHY parse_csv_records: [explain the design reason]
# WHY make_dedup_key: [explain the design reason]
# WHY deduplicate: [explain the design reason]
# WHY find_duplicate_groups: [explain the design reason]
...
|----------|-----|----------------------|
| parse_csv_records function | [reason] | [alternative] |
| make_dedup_key function | [reason] | [alternative] |
| deduplicate function | [reason] | [alternative] |
