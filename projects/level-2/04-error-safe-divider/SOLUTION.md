# Solution: Level 2 / Project 04 - Error Safe Divider
...
```python
# WHY safe_divide: [explain the design reason]
# WHY batch_divide: [explain the design reason]
# WHY summarise_results: [explain the design reason]
# WHY parse_operations_file: [explain the design reason]
...
|----------|-----|----------------------|
| safe_divide function | [reason] | [alternative] |
| batch_divide function | [reason] | [alternative] |
| summarise_results function | [reason] | [alternative] |
