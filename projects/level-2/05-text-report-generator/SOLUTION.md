# Solution: Level 2 / Project 05 - Text Report Generator
...
```python
# WHY parse_records: [explain the design reason]
# WHY group_by: [explain the design reason]
# WHY compute_stats: [explain the design reason]
# WHY extract_numeric: [explain the design reason]
...
|----------|-----|----------------------|
| parse_records function | [reason] | [alternative] |
| group_by function | [reason] | [alternative] |
| compute_stats function | [reason] | [alternative] |
