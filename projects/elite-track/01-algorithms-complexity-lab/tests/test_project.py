"""Tests for Algorithms and Complexity Lab."""
...
def test_build_summary_core_fields() -> None:
    ...
    payload = project.build_summary(records, "Algorithms and Complexity Lab", "test-run")

    assert payload["project_title"] == "Algorithms and Complexity Lab"
...
def test_main_like_flow_writes_output(tmp_path: Path) -> None:
    ...
    payload = project.build_summary(records, "Algorithms and Complexity Lab", "integration-test")
    ...
    assert loaded["project_title"] == "Algorithms and Complexity Lab"
