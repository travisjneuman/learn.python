"""Tests for Distributed Cache Simulator."""
...
def test_build_summary_core_fields() -> None:
    ...
    payload = project.build_summary(records, "Distributed Cache Simulator", "test-run")

    assert payload["project_title"] == "Distributed Cache Simulator"
...
def test_main_like_flow_writes_output(tmp_path: Path) -> None:
    ...
    payload = project.build_summary(records, "Distributed Cache Simulator", "integration-test")
    ...
    assert loaded["project_title"] == "Distributed Cache Simulator"
