"""Tests for Open Source Maintainer Simulator."""
...
def test_build_summary_core_fields() -> None:
    ...
    payload = project.build_summary(records, "Open Source Maintainer Simulator", "test-run")

    assert payload["project_title"] == "Open Source Maintainer Simulator"
...
def test_main_like_flow_writes_output(tmp_path: Path) -> None:
    ...
    payload = project.build_summary(records, "Open Source Maintainer Simulator", "integration-test")
    ...
    assert loaded["project_title"] == "Open Source Maintainer Simulator"
