# Elite Track / Open Source Maintainer Simulator
...
Triage issues, classify contribution quality, and prioritize maintainer actions.

## Run (copy/paste)
Use `<repo-root>` as the folder containing this repository's `README.md`.

```bash
cd <repo-root>/projects/elite-track/09-open-source-maintainer-simulator
