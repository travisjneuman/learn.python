"""Tests for Concurrent Job System."""
...
def test_build_summary_core_fields() -> None:
    ...
    payload = project.build_summary(records, "Concurrent Job System", "test-run")

    assert payload["project_title"] == "Concurrent Job System"
...
def test_main_like_flow_writes_output(tmp_path: Path) -> None:
    ...
    payload = project.build_summary(records, "Concurrent Job System", "integration-test")
    ...
    assert loaded["project_title"] == "Concurrent Job System"
