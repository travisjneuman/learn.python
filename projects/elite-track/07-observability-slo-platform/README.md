# Elite Track / Observability SLO Platform
...
Calculate SLI/SLO status and produce actionable reliability reporting.

## Run (copy/paste)
Use `<repo-root>` as the folder containing this repository's `README.md`.

```bash
cd <repo-root>/projects/elite-track/07-observability-slo-platform
