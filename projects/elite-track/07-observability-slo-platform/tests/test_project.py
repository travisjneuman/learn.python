"""Tests for Observability SLO Platform."""
...
def test_build_summary_core_fields() -> None:
    ...
    payload = project.build_summary(records, "Observability SLO Platform", "test-run")

    assert payload["project_title"] == "Observability SLO Platform"
...
def test_main_like_flow_writes_output(tmp_path: Path) -> None:
    ...
    payload = project.build_summary(records, "Observability SLO Platform", "integration-test")
    ...
    assert loaded["project_title"] == "Observability SLO Platform"
