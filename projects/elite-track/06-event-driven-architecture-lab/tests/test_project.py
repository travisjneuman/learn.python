"""Tests for Event Driven Architecture Lab."""
...
def test_build_summary_core_fields() -> None:
    ...
    payload = project.build_summary(records, "Event Driven Architecture Lab", "test-run")

    assert payload["project_title"] == "Event Driven Architecture Lab"
...
def test_main_like_flow_writes_output(tmp_path: Path) -> None:
    ...
    payload = project.build_summary(records, "Event Driven Architecture Lab", "integration-test")
    ...
    assert loaded["project_title"] == "Event Driven Architecture Lab"
