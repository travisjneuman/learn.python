# Elite Track / Staff Engineer Capstone
...
Integrate architecture, reliability, security, and communication evidence into one system.

## Run (copy/paste)
Use `<repo-root>` as the folder containing this repository's `README.md`.

```bash
cd <repo-root>/projects/elite-track/10-staff-engineer-capstone
...
- Continue to [expansion modules](../../modules/README.md).
