# Level 7 / Project 02 - Input and Output Checker
...
## Alter it
Move settings to config and support multiple environments.

## Break it
Use conflicting config values and resolve precedence.
