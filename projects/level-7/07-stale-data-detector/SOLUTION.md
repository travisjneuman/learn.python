...
```python
# WHY default_rules: [explain the design reason]
# WHY merge_rules: [explain the design reason]
# WHY classify_age: [explain the design reason]
# WHY check_sources: [explain the design reason]
# WHY summarise: [explain the design reason]
...
|----------|-----|----------------------|
| default_rules function | [reason] | [alternative] |
| merge_rules function | [reason] | [alternative] |
| classify_age function | [reason] | [alternative] |
