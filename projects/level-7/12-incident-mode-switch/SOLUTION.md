...
```python
# WHY stages_from_config: [explain the design reason]
...
# WHY can_transition: [explain the design reason]
# WHY switch_mode: [explain the design reason]
# WHY active_stages: [explain the design reason]
# WHY skipped_stages: [explain the design reason]
...
|----------|-----|----------------------|
| stages_from_config function | [reason] | [alternative] |
