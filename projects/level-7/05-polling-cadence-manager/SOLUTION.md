...
```python
# WHY compute_hash: [explain the design reason]
# WHY poll_once: [explain the design reason]
# WHY simulate_polling: [explain the design reason]
...
|----------|-----|----------------------|
| compute_hash function | [reason] | [alternative] |
| poll_once function | [reason] | [alternative] |
| simulate_polling function | [reason] | [alternative] |
