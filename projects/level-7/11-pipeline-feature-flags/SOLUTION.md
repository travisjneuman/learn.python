...
```python
# WHY flags_from_config: [explain the design reason]
...
# WHY register: [explain the design reason]
# WHY is_enabled: [explain the design reason]
# WHY evaluate_all: [explain the design reason]
# WHY _record: [explain the design reason]
...
|----------|-----|----------------------|
| flags_from_config function | [reason] | [alternative] |
