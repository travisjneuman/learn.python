# Solution: Level 4 / Project 08 - Malformed Row Quarantine
...
# WHY rule_column_count: [explain the design reason]
# WHY rule_no_empty_required: [explain the design reason]
# WHY rule_no_control_chars: [explain the design reason]
# WHY rule_max_field_length: [explain the design reason]
# WHY quarantine_rows: [explain the design reason]
...
| rule_column_count function | [reason] | [alternative] |
| rule_no_empty_required function | [reason] | [alternative] |
