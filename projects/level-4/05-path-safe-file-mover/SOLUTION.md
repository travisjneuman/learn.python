# Solution: Level 4 / Project 05 - Path Safe File Mover
...
# WHY resolve_collision: [explain the design reason]
# WHY plan_moves: [explain the design reason]
# WHY execute_moves: [explain the design reason]
# WHY _rollback: [explain the design reason]
...
| resolve_collision function | [reason] | [alternative] |
| plan_moves function | [reason] | [alternative] |
