...
```python
# WHY init_tracking_db: [explain the design reason]
# WHY get_table_schema: [explain the design reason]
# WHY schema_to_dict: [explain the design reason]
# WHY save_snapshot: [explain the design reason]
# WHY get_latest_snapshot: [explain the design reason]
# WHY detect_drift: [explain the design reason]
...
|----------|-----|----------------------|
| init_tracking_db function | [reason] | [alternative] |
| get_table_schema function | [reason] | [alternative] |
| schema_to_dict function | [reason] | [alternative] |
