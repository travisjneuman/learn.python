...
# WHY get_watermark: [explain the design reason]
# WHY set_watermark: [explain the design reason]
# WHY incremental_load: [explain the design reason]
# WHY count_events: [explain the design reason]
...
| get_watermark function | [reason] | [alternative] |
| set_watermark function | [reason] | [alternative] |
