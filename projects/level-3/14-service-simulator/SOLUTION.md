# Solution: Level 3 / Project 14 - Service Simulator
...
```python
# WHY retry_request: [explain the design reason]
# WHY run_load_test: [explain the design reason]
# WHY build_parser: [explain the design reason]
# WHY main: [explain the design reason]
# WHY __init__: [explain the design reason]
# WHY _random_latency: [explain the design reason]
# WHY request: [explain the design reason]
# WHY get_log: [explain the design reason]
...
|----------|-----|----------------------|
| retry_request function | [reason] | [alternative] |
| run_load_test function | [reason] | [alternative] |
| build_parser function | [reason] | [alternative] |
