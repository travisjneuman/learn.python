# Solution: Level 5 / Project 04 - Config Layer Priority
...
# WHY load_file_config: [explain the design reason]
# WHY load_env_config: [explain the design reason]
# WHY coerce_types: [explain the design reason]
# WHY resolve_config: [explain the design reason]
# WHY get_config_sources: [explain the design reason]
...
| load_file_config function | [reason] | [alternative] |
| load_env_config function | [reason] | [alternative] |
