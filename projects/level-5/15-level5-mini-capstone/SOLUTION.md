# Solution: Level 5 / Project 15 - Level 5 Mini Capstone
...
# WHY load_config: [explain the design reason]
# WHY extract_csv_files: [explain the design reason]
# WHY transform_rows: [explain the design reason]
# WHY check_thresholds: [explain the design reason]
# WHY atomic_write: [explain the design reason]
...
| load_config function | [reason] | [alternative] |
| extract_csv_files function | [reason] | [alternative] |
