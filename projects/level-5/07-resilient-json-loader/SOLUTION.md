# Solution: Level 5 / Project 07 - Resilient JSON Loader
...
# WHY read_text_safe: [explain the design reason]
# WHY try_load_json: [explain the design reason]
# WHY try_repair_json: [explain the design reason]
# WHY load_with_fallbacks: [explain the design reason]
...
| read_text_safe function | [reason] | [alternative] |
| try_load_json function | [reason] | [alternative] |
