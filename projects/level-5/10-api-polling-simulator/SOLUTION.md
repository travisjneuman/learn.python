# Solution: Level 5 / Project 10 - API Polling Simulator
...
# WHY calculate_backoff: [explain the design reason]
# WHY poll_with_backoff: [explain the design reason]
...
# WHY get_status: [explain the design reason]
...
| calculate_backoff function | [reason] | [alternative] |
| poll_with_backoff function | [reason] | [alternative] |
