# Solution: Level 5 / Project 01 - Schedule Ready Script
...
# WHY is_within_time_window: [explain the design reason]
# WHY is_skip_day: [explain the design reason]
# WHY acquire_lock: [explain the design reason]
# WHY release_lock: [explain the design reason]
# WHY do_work: [explain the design reason]
...
| is_within_time_window function | [reason] | [alternative] |
| is_skip_day function | [reason] | [alternative] |
