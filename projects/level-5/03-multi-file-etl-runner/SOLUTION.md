# Solution: Level 5 / Project 03 - Multi File ETL Runner
...
# WHY extract_csv: [explain the design reason]
# WHY transform_row: [explain the design reason]
# WHY merge_append: [explain the design reason]
# WHY merge_deduplicate: [explain the design reason]
# WHY merge_update: [explain the design reason]
# WHY run_etl: [explain the design reason]
...
| extract_csv function | [reason] | [alternative] |
