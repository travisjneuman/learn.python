...
# WHY total_monthly: [explain the design reason]
# WHY by_type: [explain the design reason]
# WHY to_dict: [explain the design reason]
# WHY __init__: [explain the design reason]
# WHY estimate: [explain the design reason]
# WHY what_if: [explain the design reason]
# WHY _generate_recommendations: [explain the design reason]
