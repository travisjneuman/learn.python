...
# WHY value: [explain the design reason]
# WHY error_budget_pct: [explain the design reason]
# WHY error_budget_remaining_pct: [explain the design reason]
# WHY in_compliance: [explain the design reason]
# WHY burn_rate: [explain the design reason]
# WHY to_dict: [explain the design reason]
# WHY __init__: [explain the design reason]
# WHY add_slo: [explain the design reason]
# WHY get_slo: [explain the design reason]
# WHY record_event: [explain the design reason]
# WHY check_burn_rates: [explain the design reason]
# WHY compliance_report: [explain the design reason]
