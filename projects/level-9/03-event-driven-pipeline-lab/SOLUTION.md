...
# WHY append: [explain the design reason]
# WHY subscribe: [explain the design reason]
# WHY get_events: [explain the design reason]
# WHY get_state_at: [explain the design reason]
# WHY all_events: [explain the design reason]
# WHY __init__: [explain the design reason]
# WHY handle: [explain the design reason]
# WHY __init__: [explain the design reason]
# WHY handle: [explain the design reason]
# WHY __init__: [explain the design reason]
# WHY handle: [explain the design reason]
# WHY inventory_reducer: [explain the design reason]
