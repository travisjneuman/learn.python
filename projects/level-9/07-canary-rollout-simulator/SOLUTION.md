...
```python
# WHY default_stages: [explain the design reason]
# WHY run_demo: [explain the design reason]
# WHY parse_args: [explain the design reason]
# WHY main: [explain the design reason]
# WHY error_rate_delta: [explain the design reason]
# WHY latency_delta_ms: [explain the design reason]
# WHY to_dict: [explain the design reason]
# WHY to_dict: [explain the design reason]
# WHY __init__: [explain the design reason]
# WHY phase: [explain the design reason]
# WHY execute: [explain the design reason]
...
|----------|-----|----------------------|
| default_stages function | [reason] | [alternative] |
