...
# WHY register_asset: [explain the design reason]
# WHY add_retention_policy: [explain the design reason]
# WHY add_access_policy: [explain the design reason]
# WHY audit_assets: [explain the design reason]
# WHY evaluate_access: [explain the design reason]
# WHY _check_retention: [explain the design reason]
# WHY _check_classification: [explain the design reason]
# WHY compliance_summary: [explain the design reason]
