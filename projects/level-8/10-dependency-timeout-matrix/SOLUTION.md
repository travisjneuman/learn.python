...
```python
# WHY build_timeout_matrix: [explain the design reason]
# WHY analyze_matrix: [explain the design reason]
...
# WHY check: [explain the design reason]
# WHY _default_simulate: [explain the design reason]
# WHY all_results: [explain the design reason]
# WHY simulate: [explain the design reason]
...
|----------|-----|----------------------|
| build_timeout_matrix function | [reason] | [alternative] |
| analyze_matrix function | [reason] | [alternative] |
