...
1. **[Part 1: functools](./functools-and-itertools-part1.md)** — `partial`, `lru_cache`, `reduce`, and `wraps`
2. **[Part 2: itertools](./functools-and-itertools-part2.md)** — `chain`, `combinations`, `groupby`, `islice`, infinite iterators, and more
